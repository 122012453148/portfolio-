  ...
  >
    ...
    <div className="w-full bg-black/5 rounded-full h-2.5 overflow-hidden">
      <motion.div 
        ...
        className="h-2.5 rounded-full bg-gradient-to-r from-[#860098] to-[#F7D724]"
      ></motion.div>
    </div>
  </motion.div>
);
  ...
  return (
    <section id="skills" className="py-24 px-4 md:px-16 relative z-10">
      ...
      <div className="mt-10 mb-20">
        <Marquee gradient={true} gradientColor={[255, 255, 255]} gradientWidth={100} speed={40} className="py-4">
          {[...SKILLS.frontend, ...SKILLS.backend, ...SKILLS.database].map((skill, idx) => (
            <div key={idx} className="flex items-center gap-3 mx-8 glass-panel px-6 py-3 rounded-full border border-black/5">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} scale={1.02} transitionSpeed={2000}>
          <div className="glass-panel p-8 rounded-3xl border border-black/5 relative overflow-hidden group hover:border-[#860098]/30 transition-all duration-300">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#860098]/5 blur-3xl rounded-full"></div>
            <h3 className="text-2xl font-outfit font-bold text-gray-900 mb-8">Frontend Development</h3>
        ...
        <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} scale={1.02} transitionSpeed={2000}>
          <div className="glass-panel p-8 rounded-3xl border border-black/5 relative overflow-hidden group hover:border-[#860098]/30 transition-all duration-300">
            ...
            <h3 className="text-2xl font-outfit font-bold text-gray-900 mb-8">Backend & Database</h3>
